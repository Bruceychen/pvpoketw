...
<div class="section battle">
		...
		<div class="playback section white">
			<div class="flex">
				...
				<select class="playback-speed">
					<option value="1">一倍速度*</option>
					<option value="4">四倍速度</option>
					<option value="8" selected >八倍速度</option>
					<option value="16">十六倍速度</option>
				</select>
				<select class="playback-scale">
					<option value="fit" selected>調成適當大小</option>
					<option value="zoom">放大拉近</option>
				</select>
			</div>
	...
	<div class="section white battle-results multi">
		<a class="toggle active" href="#">總體模擬結果 <span class="arrow-down">&#9660;</span><span class="arrow-up">&#9650;</span></a>
