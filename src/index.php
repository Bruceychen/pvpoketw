...
<div class="section home white">
    ...
    <h4>v1.22.21 (八月 20, 2021)</h4>
    <ul>
        <li>搜尋關鍵字增加 "gen8"(八世代)以及 "galar"(伽勒爾地區限定)</li>
        <ul>
            <li>原關鍵字 "Galarian" 現在則專指 "具有伽勒爾型態與其他地區型態的寶可夢" (如 泥巴魚 呆殼獸等)</li>
        </ul>
    </ul>

    <h4>v1.22.20 (八月 19, 2021)</h4>
    <ul>
        <li>伽勒爾地區寶可夢加入排名。</li>
        <li>AI控制寶可夢不會再用具降低自身特性的招式作為虛招欺敵</li>
    </ul>
    ...
    <h3>最後更新時間</h3>
            <ul>
                <li>中文版最後更新時間：Mon Aug 23 09:00:00 2021 +0800</li>
                <li>原版最後版本時間：Sun Aug 22 07:33:02 2021 -0500</li>
            </ul>
</div>
