		...
		<div class="ranking-filter">
			...
			<select class="category-select">
				...
				<optgroup label="Stats">
					<option value="overall" scenario="leads" sort="statproduct">數值總和</option>
					<option value="overall" scenario="leads" sort="attack">攻擊優先</option>
					<option value="overall" scenario="leads" sort="defense">防禦優先</option>
					<option value="overall" scenario="leads" sort="stamina">HP優先</option>
				</optgroup>
			</select>
		</div>
	</div>
